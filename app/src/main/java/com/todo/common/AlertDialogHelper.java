...
//        this.current_activity = (AppCompatActivity) context;
    ...
    public void showAlertDialog(String title,String message,String positive,String negative,String neutral,final int from,boolean isCancelable)
    {
        ...
        alertDialog = alertDialogBuilder.create();
        alertDialog.show();
        alertDialog.getButton(alertDialog.BUTTON_NEGATIVE).setTextColor(Color.parseColor("#EA4744"));
        alertDialog.getButton(alertDialog.BUTTON_POSITIVE).setTextColor(Color.parseColor("#EA4744"));
    }
